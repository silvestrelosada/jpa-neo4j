...
import com.company.test.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories(basePackages="com.company.test.repository",transactionManagerRef="transactionManager")
