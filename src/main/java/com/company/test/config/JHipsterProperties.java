...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jpa_neo4j_test@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jpa_neo4j_test API";

        private String description = "jpa_neo4j_test API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jpa_neo4j_test";
