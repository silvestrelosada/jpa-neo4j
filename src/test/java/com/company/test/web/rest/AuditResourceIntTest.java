...
import com.company.test.JpaNeo4JTestApp;
import com.company.test.config.audit.AuditEventConverter;
import com.company.test.domain.PersistentAuditEvent;
import com.company.test.repository.PersistenceAuditEventRepository;
import com.company.test.service.AuditEventService;
...
@SpringApplicationConfiguration(classes = JpaNeo4JTestApp.class)
@WebAppConfiguration
@IntegrationTest
@Transactional
